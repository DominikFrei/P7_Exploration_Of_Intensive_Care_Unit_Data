...
Since our goal is prediction we will do a three way split, train:test:validation (6:2:2)
```{r}
#set seed
set.seed(1)
...
data_los_icu_rest <- data_los_icu[-train,]

#partition for testing set
test <- createDataPartition(data_los_icu_rest$icu_los_day, p = 0.5, list = FALSE)

#create testing set
data_los_icu_test <- data_los_icu_rest[test,]
#create validation set
data_los_icu_val <- data_los_icu_rest[-test,]
```
