---
title: "P7_Exploration_Of_Intensive_Care_Unit_Data"
author: "Dominik Frei"
date: "`r Sys.Date()`"
output:
  html_document:
...
```
We will try to assess, if the values are missing in a certain pattern or at random.
...
Does this coincide with any patterns in other variables? If yes, this could introduce
bias in possible further analyses.
